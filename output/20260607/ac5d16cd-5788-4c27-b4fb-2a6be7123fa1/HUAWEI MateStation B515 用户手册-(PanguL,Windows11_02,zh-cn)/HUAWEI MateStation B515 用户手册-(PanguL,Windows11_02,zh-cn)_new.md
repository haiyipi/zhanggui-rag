...
![介绍HUAWEI MateStation B515的外观、键盘及电源键使用方法，包括开机、关机和强制关机操作。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateStationB515用户手册-(PanguL,Windows11_02,zh-cn)/78c14164fe0d3bc2bd19e718359f50b42f6f33421eff17cdd120025079ffd851.jpg)

<table><tr><td>1</td><td>电源键·关机状态下,短按电源键,可开启计算机。·开机状态下,长按电源键10秒以上,可强制关闭计算机。</td></tr><tr><td>2</td><td>耳麦接口连接耳机。</td></tr><tr><td>3</td><td>USB-A (USB 3.2 Gen 2) 接口连接手机、U盘等外接设备传输数据。</td></tr><tr><td>4</td><td>USB-C 接口·连接手机、U盘等外接设备传输数据。·开机状态下可对手机等设备快充。</td></tr><tr><td>5</td><td>麦克风输入接口连接麦克风,可将麦克风接收到的声音输入计算机。</td></tr><tr><td>6</td><td>音频输出接口连接音箱等外部设备,将计算机内的音频信号传送至外部设备。</td></tr><tr><td>7</td><td>音频输入接口连接外部音频设备,将外部设备声音传送至计算机。</td></tr><tr><td>8</td><td>HDMI 接口高清晰度多媒体接口,连接显示设备。</td></tr><tr><td>9</td><td>VGA接口接入 VGA 线缆,连接显示设备。</td></tr><tr><td>10</td><td>USB-A (USB 3.2 Gen 1) 接口 x 2连接手机、U 盘等外接设备传输数据。</td></tr><tr><td>11</td><td>USB-A (USB 2.0) 接口连接手机、U 盘等外接设备传输数据。</td></tr><tr><td>12</td><td>USB-A (USB 2.0) 接口(华为指纹键盘专用)·连接手机、U 盘等外接设备传输数据。·接入华为指纹键盘。如果计算机配置的是华为指纹键盘,必须接入此口,才能实现通过键盘指纹键一键开机、解锁。</td></tr><tr><td>13</td><td>RJ45 接口连接网线。</td></tr><tr><td>14</td><td>串口连接调制解调器、串行打印机、仿真器或有串口的设备。</td></tr><tr><td>15</td><td>电源接口连接计算机电源线。</td></tr></table>

# 键盘

i 计算机配置的键盘不同，支持功能也会不同，请以实际为准。

# 快捷键功能介绍

部分型号键盘的 F1、F2 等键默认为快捷键（热键）模式，可用于轻松执行常见任务。

<table><tr><td>F1</td><td>降低屏幕亮度i 仅支持华为品牌显示器。</td></tr><tr><td>F2</td><td>增强屏幕亮度i 仅支持华为品牌显示器。</td></tr><tr><td>F4</td><td>开启或关闭静音</td></tr><tr><td>F5</td><td>减小音量</td></tr><tr><td>F6</td><td>增大音量</td></tr><tr><td>F8</td><td>切换屏幕投影模式</td></tr></table>
...
![商标声明：Bluetooth®为注册商标，使用受限；HDMI指高清晰度多媒体接口。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateStationB515用户手册-(PanguL,Windows11_02,zh-cn)/b0603d44dea04c362b9b8246f6372a5e96ad8fa63be8b3a07b8079ac4d9f40a3.jpg)  
