...
![Windows 10系统功能介绍及访问方式，附带注意事项和指示标志说明。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/4e7cda74a8e798c48a6390f10c759a4aa78afb439d9df85a5f1fe27d34e47bad.jpg)
...
![HUAWEI MateBook B5-420 正面外观介绍：显示屏与指纹式电源键位置及功能说明。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/401a542796a5be9728e1e507c9ddbcf0e77823745069a6f5f47500dca7db2375.jpg)
...
![MateBook B5-420左侧布局：包括键盘、触控板及USB-C接口，支持充电与外设连接。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/7b6e85b5c377c02a127ed16b7f8b878e73ee746519758981983d68b6a0253d61.jpg)
...
![右侧面接口：迷你RJ45转接线接口（仅此型号特有）及USB 2.0接口，用于网络连接和数据传输。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/ad7099c9ccfba6f78b5615ce80c5bbdf9dd1cf2e55ea4b4ad368866999f7fbd7.jpg)
...
![底部接口说明：包括USB 3.0接口用于数据传输，及摄像头排水孔设计防止液体损坏。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/3b28ba5f74d43558005b985a84085831d96a004638846ad00fe1e81a7c30d17d.jpg)
...
![Fn键与方向键组合使用介绍，实现Home、PgUp、PgDn及End功能。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/a28e3ba458917a1678dda647b7ca7192b46d9bdab0310f817b37dcadfd97a476.jpg)
...
![单指点击触摸板，相当于单击鼠标左键操作。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/ef98b503ec1e4c3dc8b4404ccc758da42d9c91d426ad822d73805877cc48bded.jpg)

单指点击：相当于单击鼠标左键

![单指点击触控板，相当于单击鼠标左键操作。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/86de5e9e7f944978d23f51b385a49931d39384330fef1f2c48223ff316119660.jpg)
...
![设置触摸板功能及使用电源适配器为内置电池充电的说明。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/a3a8afab4143d0287909b24f4662f96e78c1328c755d6aa6c3039236a60a97fd.jpg)
...
![为计算机充电的方法及注意事项，包括使用原装配件、适宜环境温度和通风要求。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/71d9ec8074d66adc1894a2ee66aff2e87777b778a3932a0e92f579b2c9c0d637.jpg)
...
![新机连接无线网络步骤及Windows系统激活方法简述](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/7bf66fc61481ff1c453a828e30c4aca73b5d7da5031498fae6f3e8775d0459d6.jpg)
...
![图片标题：介绍Office激活支持热线及访问链接，并指导用户如何录入指纹以实现快捷安全开机与解锁。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/5df6849a3e6987e577a05a875abeb21425e19a05731c2e0f00134373e3a7569f.jpg)
...
![设置登录密码、PIN码及指纹录入方法与注意事项，每个账户最多可录入10组指纹。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/5628e068435e755c8eb4753352b6e3a85fe831cc4b033f1ff225a6290b8ca1dd.jpg)
...
![升级驱动以提升性能，介绍华为分享与多屏协同功能。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/84e6fa8bf1ff0655fbfd58157713f04634277d622f5bc2cb550205f65d7a5d01.jpg)
...
![图片标题：介绍手机文档同步至笔记本及开启护眼模式的方法。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/56795678fbc7bd0400a7e1bad8bb9c50c0b57c593a0caeb114bc87974d3f7e46.jpg)
...
![开启护眼模式步骤及效果说明，屏幕会偏黄以保护视力。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/ad42c8f4ea41ac8663fbd1d0ac0b952d0b9bf0a0e8dbb4946a29f7f99682f266.jpg)
...
![介绍如何通过开始菜单访问应用、设置及文件夹，并提供账户管理与系统操作选项。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/c64a303f702c21eb5544930ea030145fec9032331ff355a290ef23ae9a48cc16.jpg)
...
![操作中心介绍：快速访问设置与常用功能调整，及新通知提醒区域说明。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/b9cd8e59950ea56786ffe7a01bc7de3ec1c121083d72601410c309a7cd0debc4.jpg)
...
![如何在桌面上显示“此电脑”图标及扩展坞简介](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/2f3aba1d5c6895935821ec12d2e15e29b2797bd665bfbaf45da67aab3635ab1a.jpg)
...
![扩展坞接口说明：USB-C插头连接电脑，USB接口连接鼠标等设备。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/8abcf15ebe11ea05a42621e76b12617b25406ab9800f925feeeb943f29999de3.jpg)
...
![通过扩展坞连接电脑与大屏设备，并设置投影方式以优化观影或会议演示效果。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/f4596a3396d45b90e4fc02f28cf064b50305c989d1f88e5eadad072edbe2b7ed.jpg)
...
![蓝牙鼠标与电脑配对步骤示意图，展示从开启鼠标到完成连接的全过程。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/209ee5c5f41deb8c011fe2f8fbd0bf7ba49fa96a2d0b2b1eb66cd4b612ed6bbf.jpg)

![华为鼠标结构示意图，展示左键、滚轮+中键、右键等部件位置。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/00a758eb1d114673fb7e0e6c4fae411b2bcf994dbb0175166643e44ed8bcbac4.jpg)
...
![鼠标电池安装示意图：展示如何打开鼠标后盖并正确安装AA电池。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/efe7d00e6220316c2699b93cf51c568be4d0c87743d6dc92c14b608dbe8301d0.jpg)

![电池安装步骤：将电池放入槽位，合上后盖即完成安装。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/f23bf5bce767b427a05b5de081ee1203fa5ffbcb87e96faacc053ee8703c7fca.jpg)

![蓝牙鼠标与HUAWEI MateBook B5-420的配对步骤说明。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/1896cd6851fc02e95c61b21d0ab15674d6ef258c111a26bdc7ec83b6e5fba671.jpg)

# 蓝牙鼠标与计算机配对

![蓝牙鼠标与HUAWEI MateBook B5-420配对步骤示意图](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/9401ba38611a7034d18cbbc6c6162733656d20ce6847670deab5c5d8b73bcb34.jpg)

![蓝牙鼠标底部配对开关位置及如何拨动以进入配对模式的示意图。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/9c0c37de1b2940f8768ed3a7540f1df5f60ad47d3568c294e000a6c85b6c2ee7.jpg)

![鼠标底部配对开关拨动示意图及指示灯位置，展示如何使鼠标进入配对状态。](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/5ae94efd2d0351c8fbb99b5a0bab44048ee0034ce3f9462f372802c780ed6f5c.jpg)
...
![中国RoHS合格评定标识说明及软件版权保护声明](http://localhost:9000/knowledge-base-files/upload-images/HUAWEIMateBookB5-420用户手册-(05,zh-cn,KLV&KLVC&KLCZ)/0f6f1a6aa4fe14fbced500dd35f7777d7061c6eb45147e9bcc166fbced286beb.jpg)
