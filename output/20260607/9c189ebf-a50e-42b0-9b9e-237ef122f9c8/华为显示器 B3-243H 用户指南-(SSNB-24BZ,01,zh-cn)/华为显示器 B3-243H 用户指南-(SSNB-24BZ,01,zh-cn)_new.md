...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/5bc0a89e458c163d0d906029a46a30196eae56f172cd67d4739f0f9ea0fbf8b2.jpg)

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/511a901a8cfb27960c50745e7be4074f5cc0604b6f0c1f440e9b2210c1928f43.jpg)

<table><tr><td>序列号</td><td>按键功能</td></tr><tr><td>1</td><td>五向摇杆按键·向上短按此键开机,长按2秒以上关机。·开机状态下,向上、前、后、左、右短按均可调出菜单,向屏幕前、后、左、右短按可以设置菜单。更多内容,请参考章节使用五向摇杆按键开关机、设置菜单。</td></tr><tr><td>2</td><td>电源接口连接电源适配器,给显示器供电。</td></tr><tr><td>3</td><td>DP接口连接DP输入设备,如计算机。</td></tr><tr><td>4</td><td>HDMI接口连接HDMI输入设备,如计算机。</td></tr></table>

# 安装与拆卸显示器

# 配置 SSNB-24

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/8579b6831ec66e99ba9e9d351baeaf366dd99ea9246b9ede7353bbbe0fcfd3c9.jpg)
...
0   
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/da1bd81e02fcce96ea4773f8c6f675ecd8094deb78c14965dcc924cf87699106.jpg)

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/d0fce6478202c15f3abbcb00ad2a4f4b105d2e62715c22b4b14527b3a06c320c.jpg)

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/9acedaaaa70246ec6c42810d613bc484dd8bc456d785ee4d68bc221380013047.jpg)

③   
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/35c259bbba341fb0313eb8855ea1b927570a7363386c92cf3117b0fa67118e88.jpg)

4   
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/abf81043304b28258a45fdffc9b5cf8ff8efc70b09baeac7f802ede2de13daf9.jpg)

6   
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/e90996f518bda52862b522a56afd9931e91f223f97f1d4553ea5209791318ef8.jpg)
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/1e2e777d858a0a23714a7c23b74e0789b013d58e81dfc172c648bfac05c3a078.jpg)
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/f0811d53435eb62666cf7f152f208efdc92df6977d22527cb734fb620ccad281.jpg)
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/b8100acf176393b701c84bcd0032ae186a74f2bb2b6b6018cb8903559ce9c76f.jpg)

：面向屏幕时（下同），向屏幕前、后、左、右按五向摇杆按键，可移动切换选项。

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/c25be6278f9f71746a79909a3a210b55e59f98b75bb7df025a87f7b214ff098c.jpg)

：向左按五向摇杆按键，可返回至上一级菜单或退出菜单。

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为显示器B3-243H用户指南-(SSNB-24BZ,01,zh-cn)/65ebc3f5162c95e918dafe4c54662a92311aa8ccd29305cc838e28ff0e119798.jpg)
...
<table><tr><td>一级菜单</td><td>二级菜单</td><td>描述</td></tr><tr><td rowspan="6"><img src="images/cc4c5778e93ccbacbf9d8a7e21fa7d402691f069b9f2f5d41b1f62f37aa8548e.jpg"/>情景模式</td><td>P3色彩</td><td>浏览P3广色域图片或喜好鲜艳色彩的人士,建议选择P3色彩。</td></tr><tr><td>sRGB色彩</td><td>浏览计算机中的图片时,建议选择sRGB色彩。</td></tr><tr><td>HDR色彩</td><td>调色模拟HDR视频色彩效果,建议观赏影视场景使用。</td></tr><tr><td>游戏</td><td>游戏效果增强,建议游戏场景使用。</td></tr><tr><td>电子书</td><td>模拟纸质书籍效果,建议阅读场景使用。</td></tr><tr><td>用户</td><td>用户自定义显示效果。</td></tr><tr><td rowspan="6"><img src="images/246004f2ad0144187c36c0e73cf635d7c5727f8aa487e10f41c3a22618a223da.jpg"/>显示</td><td>亮度</td><td>设置范围为0-100。</td></tr><tr><td>对比度</td><td>设置范围为0-100。i 此功能仅在用户/sRGB色彩/P3色彩模式下且关闭护眼模式,才可使用。</td></tr><tr><td>锐利度</td><td>设置范围为0-100。</td></tr><tr><td>护眼</td><td>可开启或关闭护眼模式。i 长期阅读时,建议开启护眼模式,预防用眼疲劳,使眼睛更加舒服。开启护眼模式后,屏幕显示偏黄为正常现象。此功能仅在用户/sRGB色彩/P3色彩模式下才可使用,其余的情景模式下护眼模式默认为关。</td></tr><tr><td>色温</td><td>可设置为冷色、中性色、标准色、暖色模式的一种。或者在用户自定义选项中,对红、绿、蓝颜色分别设置,设置数值为0-100。i 此功能仅在用户/sRGB色彩/P3色彩模式下且关闭护眼模式,才可使用。</td></tr><tr><td>缩放</td><td>可选择满屏或等比缩放。</td></tr><tr><td rowspan="2"><img src="images/ed263dfed64a51116328ecc6ca3275958ab087b17861bc33d8567b6ecb680073.jpg"/>输入源</td><td>HDMI</td><td rowspan="2">连接其他设备时,根据连接线缆,选择对应的输入源。</td></tr><tr><td>DP</td></tr><tr><td rowspan="2"><img src="images/6069ad78c8bf7b92a5c289382ff54619c82042b711979de3f8db3e5849efc0d7.jpg"/>游戏辅助</td><td>刷新率</td><td>在游戏场景中,可以在此菜单中进行一些辅助设置。开启后,可选择在屏幕左上角或右上角显示刷新率。</td></tr><tr><td>游戏准星</td><td>开启后,在屏幕上显示准星。并可将准星颜色设置为红色或绿色,也可对准星位置重置。</td></tr><tr><td></td><td>响应时间</td><td>可开启或关闭响应时间。开启时,可选择标准、快、极快等响应时间。</td></tr><tr><td rowspan="2"><img src="images/72f162a836c298355a9572b2c93a017dac9b1a904a6b237a23ab81ce7f0a113f.jpg"/> 快捷键</td><td>上</td><td>OSD快捷菜单上方的设置选项,默认为亮度,可设置为情景模式、响应时间、输入源、对比度等选项。</td></tr><tr><td>下</td><td>OSD快捷菜单下方的设置选项,默认为情景模式,可设置为亮度、响应时间、输入源、对比度等选项。</td></tr><tr><td rowspan="8"><img src="images/a2add535142f7ae18dfbd97ba81eb8344f065aa004ab613888b249fb0f4944f7.jpg"/> 设置</td><td>语言</td><td>可设置为简体中文、美式英语、日语等其他语种。</td></tr><tr><td rowspan="2">菜单显示设置</td><td>菜单透明度:可设置菜单的显示透明度,设置数值为1-8,数字越大透明度越高。</td></tr><tr><td>菜单显示时间:可将菜单显示时间设置为10-100秒。</td></tr><tr><td rowspan="2">LED电源按钮</td><td>待机模式时开:待机状态下,显示器的指示灯白色闪烁。</td></tr><tr><td>待机模式时关:待机状态下,显示器的指示灯熄灭。</td></tr><tr><td>信息</td><td>可查看显示器的SN号、固件版本号、情景模式、分辨率、刷新率、输入源等信息。</td></tr><tr><td>ECOMode</td><td>选择开启或关闭节能模式。此功能默认关闭,打开后会减少能耗。开启节能模式后,亮度等选项将无法设置。</td></tr><tr><td>恢复出厂设置</td><td>选择是否将显示器菜单恢复出厂设置。</td></tr></table>
