...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云W515用户指南-(PanguV,KOS_05,zh-cn)/63b49a4b6439fbcc24377a09f0940058bba2536f423712ceb37f8ef504dfbb4a.jpg)
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云W515用户指南-(PanguV,KOS_05,zh-cn)/092bf3c9021c25c8dd9119bc406a4ca6d04b56e4c8c9dd9025a2489b75bfa38a.jpg)
...
<table><tr><td><img src="images/e592275d2a7b297338bf1306d2ba1fa1019d3ef43874194d82e49d449809895d.jpg"/></td><td>降低屏幕亮度i 仅支持华为品牌显示器。</td></tr><tr><td><img src="images/ceed62c5a4bd85c503eca202765a434a997280172d7fd7ad7fb2db516c54d371.jpg"/></td><td>增强屏幕亮度i 仅支持华为品牌显示器。</td></tr><tr><td><img src="images/5759c0e345b636e9078882399ae17496d6130674b07102fa4236391fc9b353a7.jpg"/></td><td>开启或关闭静音</td></tr><tr><td><img src="images/02837fc0173354df02bc99eb707f437661e51a5aea5e6eac1d8483835aae4615.jpg"/></td><td>减小音量</td></tr><tr><td><img src="images/6c275131f4ca12ab0cd38f9e488f798bcc8c64a8c9c887423da41a5ff54093ac.jpg"/></td><td>增大音量</td></tr><tr><td><img src="images/4d34983b768db3427c5c6f89a02de134c5bab280c68192d6828b6b8d2b5bcb88.jpg"/></td><td>切换投影屏幕模式</td></tr></table>
...
配置密码：配置 BIOS 管理员密码和 BIOS 用户密码后，在进入 BIOS 设置界面时，会有界面提示您“输入配置密码”，此时，可以输入 BIOS 管理员密码或 BIOS 用户密码，但输入不同的密
...
- 若您输入的是 BIOS 用户密码（例如 456），在 BIOS 设置界面，您只能修改 BIOS 用户密码，无法修改 BIOS 管理员密码，以及无法关闭启动密码。
...
华为计算机没有设置出厂 BIOS 管理员密码和 BIOS 开机密码，也没有任何形式的通用密码，一旦设置，请妥善保管。BIOS 开机密码一旦丢失，只能更换主板，才能进入系统。

# 配置 BIOS 管理员密码、BIOS 开机密码：

1. 在开机时长按或连续点按 F2 进入 BIOS 设置界面。  
2. 在 “安全设置” （Security Setting）栏下，点击 “BIOS 配置管理员密码” （SETUP Administrator Password）或 “BIOS 开机密码” （POST Password），按 Enter 键确认，按界面提示输入并确认密码后，按 Enter 键确认。  
3. 按 F10 键保存并退出。

# 修改 BIOS 管理员密码、BIOS 开机密码：

1. 在开机时长按或连续点按 F2 进入 BIOS 设置界面。  
2. 在 “安全设置” （Security Setting）栏下，点击 “BIOS 配置管理员密码” （SETUP Administrator Password）或 “BIOS 开机密码” （POST Password），按 Enter 键确认，按界面提示输入旧密码并确认新密码后，按 Enter 键确认（若您设置新密码为空，将清除管理员密码或开机密码）。  
3. 按 F10 键保存并退出。
...
- 请在温度 $0^{\circ}\mathrm{C} \sim 35^{\circ}\mathrm{C}$ 范围内使用本产品，在 $-10^{\circ}\mathrm{C} \sim +45^{\circ}\mathrm{C}$ 范围内存储本产品。  
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云W515用户指南-(PanguV,KOS_05,zh-cn)/01c41738b51bf184cdf0884f259dfe1f44c586b686d9d6118099b946e6f74903.jpg)  
