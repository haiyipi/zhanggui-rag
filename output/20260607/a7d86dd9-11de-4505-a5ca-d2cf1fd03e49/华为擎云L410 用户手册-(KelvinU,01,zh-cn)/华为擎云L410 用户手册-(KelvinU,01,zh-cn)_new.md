...
2.2 查看 BIOS 版本信息、EC 版本信息 . . 6

2.3 恢复 BIOS 默认设置 . . 6

2.4 设置 BIOS 密码 . 6

2.4.1 BIOS 管理员密码和 BIOS 用户密码（EC 版本为 2.19 及以上的产品适用） . 6

2.4.2 BIOS 管理员密码和 BIOS 开机密码（EC 版本低于 2.19 的产品适用） 8
...
3.2 HUAWEI MINI RJ45 转 RJ45 转接线 . . 10
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/dc107e26fd3b5f1fec4118d406b6c22f2be56472c6541915cbc7b5bc039ab1d9.jpg)

<table><tr><td>1</td><td>指纹式电源键录入指纹后,您只需使用已录入指纹的手指按一下电源键,即可同时实现开机、解锁,无需输入密码,快捷安全。</td></tr><tr><td>2</td><td>隐藏式摄像头按下按钮可以弹出摄像头,与相机等应用程序配合使用时,可以进行拍照或视频交流,再次按下按钮可以收起摄像头。</td></tr><tr><td>3</td><td>摄像头指示灯了解摄像头使用状态。摄像头开启时,指示灯白色常亮。</td></tr><tr><td>4</td><td>触摸板类似鼠标的功能,更方便的操控计算机。</td></tr><tr><td>5</td><td>USB-C 接口连接电源适配器给计算机充电。连接手机、U盘等外接设备传输数据。</td></tr><tr><td>6</td><td>耳机接口连接耳机。</td></tr><tr><td>7</td><td>HDMI 接口高清晰度多媒体接口,连接显示设备。</td></tr><tr><td>8</td><td>充电指示灯充电时,显示电池充电状态:白色闪烁表示正在充电。白色常亮表示电池充满电,停止充电。</td></tr><tr><td>9</td><td>Mini RJ45 接口连接 HUAWEI Mini RJ45 转 RJ45 转接线。</td></tr><tr><td>10</td><td>USB-A (USB 3.2 Gen 1) 接口连接手机、U盘等外接设备传输数据。</td></tr><tr><td>11</td><td>麦克风使用麦克风进行视频会议、语音通话或录音。</td></tr></table>
...
<table><tr><td><img src="images/c14716a7a8e1f3cc92d56b2eddbfe7445f3f92c8a0c86372297bd4f8542c8da2.jpg"/></td><td>降低屏幕亮度</td></tr><tr><td><img src="images/bcd7715a30dacb64382401a36ab7cd8f79c95d7df33d0706e2ef48e712a42990.jpg"/></td><td>增强屏幕亮度</td></tr><tr><td><img src="images/84c171cc78c736d75877105626326497f451d1a11c5b802a8243749e5adb05f3.jpg"/></td><td>开启或关闭键盘背光,调节键盘背光亮度i 如果此按键上无一图标,则不支持背光。</td></tr><tr><td><img src="images/c23ab0eb5f75912210b4c23356c8bd6fafe2a555239df32dd54a76a2191f952c.jpg"/></td><td>开启或关闭静音</td></tr><tr><td><img src="images/5f48d007bf7c56a99b0a0d01a5b337e639435e6d1129c11aa0882b9eed3fc47e.jpg"/></td><td>减小音量</td></tr><tr><td><img src="images/e902019c1c6bcb3934b3451c78dc0b678449b2eb9f46ae28651ad5ee4897a241.jpg"/></td><td>增大音量</td></tr><tr><td><img src="images/c2507e0a7eb1415e5a6574b941fa0b92fcdb9a24a8ed7a38150b1b05b46d3963.jpg"/></td><td>开启或关闭麦克风</td></tr><tr><td><img src="images/a0f9a47cdb986d1aaa468d196d6d8d88ebc92893e328d568faaeb180c825d11c.jpg"/></td><td>切换投影屏幕模式</td></tr><tr><td><img src="images/9d2f46d8d1e69603f985f8f0fe0a9d363d899270a7db2c7ff2a300b5c5bb0ade.jpg"/></td><td>开启或关闭无线网络</td></tr></table>
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/e6ffd9fc2f5c6bebab323f853173e35ebcd451bca12aae4c2ef9c06c5dc5fcbe.jpg)

<details>
<summary>natural_image</summary>

Line drawing of a laptop with a mouse pointer indicating left-side motion (no text or symbols)
</details>
...
开机或重启时，长按或连续点按 F2 键，进入 BIOS 设置界面，在“BIOS 版本”（BIOS Version）、“EC 版本”（EC Version）中可以看到 BIOS 版本信息和 EC 版本信息。
...
第一种：BIOS 管理员密码和 BIOS 用户密码（EC 版本为 2.19 及以上的产品适用）。

第二种：BIOS 管理员密码和 BIOS 开机密码（EC 版本低于 2.19 的产品适用）。

不同的 BIOS 版本，设置的密码作用有差异，您可以根据实际情况，按需求设置。

# 2.4.1 BIOS 管理员密码和 BIOS 用户密码（EC 版本为 2.19 及以上的产品适用）

# BIOS 密码的作用：

BIOS 管理员密码：可以作为启动密码登录系统；可以作为配置密码登录 BIOS 设置界面，登录后，可以修改 BIOS 任意配置。BIOS 管理员密码权限大于 BIOS 用户密码。

BIOS 用户密码：可以作为启动密码登录系统；可以作为配置密码登录 BIOS 设置界面，

但是登录后，只能查看 BIOS 相关配置，不可以修改 BIOS 除用户密码外的其他配置。

启动密码：在 BIOS 中开启“启动时检查菜单密码”（Boot Password Enable）选项后，计算机开机进入系统或 BIOS 设置页面前，会有界面提示您 “输入启动密码”，此时输入 BIOS 管理员密码或 BIOS 用户密码都可以进入。即 BIOS 管理员密码或 BIOS用户密码都是启动密码。
...
若您输入的是 BIOS 管理员密码（例如 123），进入 BIOS 设置界面后：选择“BIOS 配置管理员密码”，按 Enter 键确认，按界面提示可以修改密码（若您设置新密码为空，将清空管理员密码）；选择“BIOS 配置用户密码”，按 Enter 键，按界面提示可以修改密码；选择“启动时检查菜单密码”，按 Enter 键，选择“关闭”，再次按 Enter 键确认选项，关闭此选项后，开机时不需要再输入启动密码。

若您输入的是 BIOS 用户密码（例如 456），在 BIOS 设置界面，您只能修改BIOS 用户密码，无法修改 BIOS 管理员密码，以及无法关闭启动密码。

3. 修改后按 F10 键保存并退出。

# 2.4.2 BIOS 管理员密码和 BIOS 开机密码（EC 版本低于 2.19 的产品适用）

# BIOS 密码作用：

BIOS 管理员密码（即 BIOS 配置密码）：进入 BIOS 设置界面时，需要输入的BIOS 配置密码，登录后，可以修改 BIOS 任意配置。但是无法作为开机密码登录系统。  
BIOS 开机密码：计算机开机进入系统或 BIOS 界面需要输入的密码。但不能作为BIOS 配置密码登录 BIOS 设置界面。  
0 华为计算机没有设置出厂 BIOS 管理员密码和 BIOS 开机密码，也没有任何形式的通用密码，一旦设置，请妥善保管。BIOS 开机密码一旦丢失，只能更换主板，才能进入系统。

# 配置 BIOS 管理员密码、BIOS 开机密码：

1. 在开机时长按或连续点按 F2 进入 BIOS 设置界面。  
2. 在“安全设置”（Security Setting）栏下，点击“BIOS 配置管理员密码”（SETUPAdministrator Password）或“BIOS 开机密码”（POST Password），按 Enter键确认，按界面提示输入并确认密码后，按 Enter 键确认。  
3. 按 F10 键保存并退出。

# 修改 BIOS 管理员密码、BIOS 开机密码：

1. 在开机时长按或连续点按 F2 进入 BIOS 设置界面。  
2. 在“安全设置”（Security Setting）栏下，点击“BIOS 配置管理员密码”（SETUPAdministrator Password）或“BIOS 开机密码”（POST Password），按 Enter键确认，按界面提示输入旧密码并确认新密码后，按 Enter 键确认（若您设置新密码为空，将清空管理员密码或开机密码）。  
3. 修改后按 F10 键保存并退出。
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/2064772f1134d1c9de246d0a04494b799f3a0c0bdd99251d0ba3ae73ad99d0f4.jpg)
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/cb275ec63e6e78b9c850248d601259016a08c2d75f9bf8ce0fb108bba2b96548.jpg)
...
<table><tr><td>1</td><td>左键</td><td>2</td><td>滚轮+中键</td></tr><tr><td>3</td><td>右键</td><td>4</td><td>LED 指示灯i指示灯为红色闪烁时,表示电池电量低,请注意更换电池。</td></tr><tr><td>5</td><td>传感器</td><td>6</td><td>电源/蓝牙配对开关</td></tr></table>

# 3.1.2 安装电池

如下图所示，沿鼠标尾部标志打开上壳，按电池仓正负极(＋－)的标志安装一节 AA 电池，合上上壳，即可安装完成。

![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/05f9fd946fd9dad3369b52d65698ca0e3bee58d1d50554b5a21ab20cf16e9009.jpg)
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/5560ac2282306e71a432d807912fb9cf7face297e0d674473b5df312392e2111.jpg)
...
```mermaid
graph LR
    A["Laptop with Mouse"] -->|Bluetooth Signal| B["Bluetooth icon"]
    B --> C["ON/OFF Off Signal"]
...
![图片描述](http://localhost:9000/knowledge-base-files/upload-images/华为擎云L410用户手册-(KelvinU,01,zh-cn)/e6590bf444dd891f7e770918cbdf3fd56ad7f6ab7d1c098aba6e39f89a6cad1d.jpg)
