...
from app.query_process.agent.state import QueryGraphState, create_default_query_state
...
if __name__ == "__main__":
    ...
    print("      ↓")
    print("  node_multi_search (分叉)")
    print("      ↓")
    print("  node_search_embedding → node_search_embedding_hyde → node_web_search_mcp")
    print("      ↓")
    print("  node_join (合并)")
    print("      ↓")
